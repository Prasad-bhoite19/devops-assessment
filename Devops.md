...
- Application is deployed locally using Docker as cloud access was not mandatory.
- Docker Hub is used as a public image registry.
- Environment variables are managed via docker-compose.yml.
- Terraform code is provided for demonstration purposes only (no live cloud deployment).

## Deployment Using Pre-Built Images

The application is deployed using Docker Hub images generated by CI/CD.
This confirms a true CI/CD flow rather than local image builds.
